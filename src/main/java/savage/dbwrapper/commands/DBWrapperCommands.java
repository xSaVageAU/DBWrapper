...
public class DBWrapperCommands {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher, DBWrapperConfig config) {
                        ...
                        .then(CommandManager.literal("mariadb")
                                .then(CommandManager.literal("create")
                                        .then(CommandManager.argument("database_name", StringArgumentType.word())
                                                .executes(context -> createDatabase(context.getSource(), StringArgumentType.getString(context, "database_name"), config))
                                        )
                                )
                        )
                )
    ...
    private static int createDatabase(ServerCommandSource source, String databaseName, DBWrapperConfig config) {
